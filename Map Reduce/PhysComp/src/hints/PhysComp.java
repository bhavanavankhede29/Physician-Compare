...
public class PhysComp {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
          "Usage: PhysComp <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(PhysComp.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("PhysComp Count");
     ...
     */
    job.setMapperClass(PhysCompMapper.class);
    job.setReducerClass(PhysCompReducer.class);
